...
export default function BmdCampReport() {
        ...
        <div className="formBody">
            <form >
                <div>
                    ...
                    />
                    <h3 className="ReportsHeading" style={{color:'rgba(50, 178, 43, 1)', fontFamily:'cursive'}}>BMD Camp <br/>Reports Download</h3>
                </div>

                <div className="container-fluid">
                    <div className="row form-row">
                        <div className="col-12 col-md-6 mt-5">
                            <div className="reportCards reportCards3"  onClick={() => downloadReport('bmdcamp')}>

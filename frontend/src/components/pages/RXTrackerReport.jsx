...
export default function RXTrackerReport() {
        ...
        <div className="formBody">
            <form >
                <div>
                    ...
                    />
                    <h3 className="ReportsHeading" style={{color:'rgba(202, 97, 49, 1)', fontFamily:'cursive'}}>RX Trackers<br/>Reports Download</h3>
                </div>

                <div className="container-fluid">
                    <div className="row form-row">
                        <div className="col-12 col-md-6 mt-5">
                            <div className="reportCards reportCards3"  onClick={() => downloadReport('rxtracker')}>

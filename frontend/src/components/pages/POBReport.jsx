...
export default function POBReport() {
        ...
        <div className="formBody">
            <form>
                <div>
                    ...
                    />
                    <h3 className="ReportsHeading" style={{color:'rgba(45, 64, 153, 1)', fontFamily:'cursive'}}>POB<br/>Reports Download</h3>
                </div>

                <div className="container-fluid">
                    <div className="row form-row">
                        <div className="col-12 col-md-6 mt-5">
                            <div className="reportCards reportCards3"  onClick={() => downloadReport('pob')}>
